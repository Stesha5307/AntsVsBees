  ...
  'suites': [
    {
      'cases': [
        {
          'answer': "Attacks the nearest bee and doubles the damage of all the ants behind her in her tunnel (that haven't already been doubled)",
          'choices': [
            r"""
            Attacks the nearest bee and doubles the damage of all the ants
            behind her in her tunnel (that haven't already been doubled)
            """,
            r"""
            Doubles the damage of all the ants behind her in her tunnel (that haven't
